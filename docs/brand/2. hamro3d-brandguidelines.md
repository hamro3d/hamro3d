...
| **L0-S** | Sub-Brand/Tagline | Under Logo | EB Garamond | Light 300 · 0.55× logo size |
...
| **Quote** | Emotional Pull | Philosophy / testimonials | EB Garamond | Light 300 · 22–26px · rose gold tint · centered |
...
| Level | Name | Usage | Font Family | Weight / Size |
| :--- | :--- | :--- | :--- | :--- |
| **Stamp** | Watermark | 3D render overlays | EB Garamond | Light 300 · 9px · 22% opacity |
| **Label** | Packaging Copy | Physical box text | EB Garamond + Jost | Mixed — display/body hierarchy |

## Experience Layer
| Level | Name | Usage | Font Family | Weight / Size |
| :--- | :--- | :--- | :--- | :--- |
| **Cert** | Authenticity | Certificates | EB Garamond | Light 300 · 14px · cream on plum |
| **Story** | Memory Note | "The story behind this" | EB Garamond | Light 300 · 17px · warm cream · centered |
...
| **Wordmark** | Stylized "HAMRO3D" text | EB Garamond · "HAMRO" in regular weight · "3D" in light 300 — gentle typographic surprise that humanizes the brand |
...
| **Checkout/Custom** | Single column · intimate guided form · step labels in EB Garamond Light 300 | Commissioning as act of love — every step feels intentional |
