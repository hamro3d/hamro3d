/**
 * Additive product seed — safe to run on a live database.
 * Uses INSERT IGNORE so existing rows are skipped without error.
 * Also adds any missing categories before inserting products.
 */
...
const CARE_KEYCHAIN = ['Keep away from direct sunlight to preserve the finish. Dust gently with a soft dry cloth. Do not expose to moisture or extreme heat.'];
...
const productsData = [
  // ─── Figurines ─────────────────────────────────────────────────────────────
  {
    ...
    head: 'FOR YOUR LOVE · PERSONALIZED PIECE', title: 'Custom Human Figurine', subtitle: 'A moment made permanent.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 1950, priceNote: PRICE_NOTE_PARTIAL,
    gif: '/gif/1.gif', images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [10, 15, 17] },
    relatedProductIds: [8, 20, 3, 14], category: 'Figurines', status: 'Active', stock: 12,
    tags: ['figurine', 'custom', 'personalized', 'gift', 'portrait', 'keepsake', 'anniversary', 'birthday'],
  },
  {
    id: 20, rank: 5, isSignaturePiece: true,
    head: 'TOGETHER · COUPLE KEEPSAKE', title: 'Couple Figurine Set', subtitle: 'Two people. One piece.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 3500, priceNote: PRICE_NOTE_PARTIAL,
    gif: '/gif/1.gif', images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [12, 8, 18] },
    relatedProductIds: [0, 8, 21, 3], category: 'Figurines', status: 'Active', stock: 15,
    tags: ['figurine', 'couple', 'wedding', 'anniversary', 'love', 'personalized', 'gift'],
  },
  {
    id: 21, rank: 8,
    head: 'FAMILY FOREVER · CHERISHED MEMORY', title: 'Family Figurine Set', subtitle: 'Everyone you love, in one piece.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 5500, priceNote: PRICE_NOTE_PARTIAL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [20, 10, 18] },
    relatedProductIds: [0, 20, 8, 22], category: 'Figurines', status: 'Active', stock: 10,
    tags: ['figurine', 'family', 'group', 'personalized', 'gift', 'keepsake', 'Dashain'],
  },
  {
    id: 22, rank: 14,
    head: 'FOR YOUR PET · BELOVED COMPANION', title: 'Pet Figurine', subtitle: 'The one who never needs words.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 1750, priceNote: PRICE_NOTE_PARTIAL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [8, 10, 12] },
    relatedProductIds: [0, 20, 14, 3], category: 'Figurines', status: 'Active', stock: 18,
    tags: ['figurine', 'pet', 'cat', 'dog', 'animal', 'personalized', 'gift'],
  },
  {
    id: 39, rank: 28,
    head: 'FOR YOUR FAITH · DEVOTIONAL PIECE', title: 'Devotional Figurine', subtitle: 'A quiet presence on your altar.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 2500, priceNote: PRICE_NOTE_PARTIAL,
    images: figImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [10, 8, 20] },
    relatedProductIds: [0, 8, 27, 20], category: 'Figurines', status: 'Active', stock: 14,
    tags: ['devotional', 'deity', 'spiritual', 'puja', 'altar', 'Nepal', 'faith', 'figurine'],
  },
  {
    id: 40, rank: 29,
    head: 'CHILDREN · PLAY WITH MEANING', title: 'Custom Storybook Figurine', subtitle: 'Their favourite character, real.',
    descriptions: [
    ...
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [8, 6, 14] },
    relatedProductIds: [0, 22, 5, 28], category: 'Figurines', status: 'Active', stock: 20,
    tags: ['children', 'storybook', 'character', 'figurine', 'gift', 'kids', 'custom', 'imagination'],
  },
  {
    id: 41, rank: 30,
    head: 'SPORTS · ACHIEVEMENT MARKED', title: 'Sports Trophy Figurine', subtitle: 'The win they will never stop talking about.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 2100, priceNote: PRICE_NOTE_FULL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [10, 8, 20] },
    relatedProductIds: [0, 37, 8, 36], category: 'Figurines', status: 'Active', stock: 12,
    tags: ['sports', 'trophy', 'figurine', 'athlete', 'cricket', 'football', 'achievement', 'gift'],
  },
  // ─── Keychains ─────────────────────────────────────────────────────────────
  {
    id: 14, rank: 4,
    head: 'IN YOUR POCKET · MEMORY YOU CAN TOUCH', title: 'Keychain Figurine', subtitle: 'A small piece you carry everywhere.',
    descriptions: [
    ...
    care: CARE_KEYCHAIN, price: 1200, priceNote: PRICE_NOTE_PARTIAL,
    gif: '/gif/1.gif', images: keyImgs, material: ['PLA'], size: { unit: 'cm', value: [4, 3, 1] },
    relatedProductIds: [4, 0, 3, 22], category: 'Keychains', status: 'Active', stock: 42,
    tags: ['keychain', 'custom', 'personalized', 'pocket', 'gift', 'daily', 'charm'],
  },
  {
    id: 4, rank: 12,
    head: 'IN YOUR POCKET · MEMORY YOU CAN TOUCH', title: 'Memory Keychain', subtitle: 'A small piece you carry everywhere.',
    descriptions: [
      'A keychain is the last thing you touch before you leave, and the first thing you touch when you return. Make it meaningful.',
      'We 3D print and hand-finish a custom charm from a photo, a sketch, or a memory. Small enough to carry. Significant enough to matter.',
      'Each keychain is made with durable PLA and attached to a quality metal ring. It arrives in a small velvet pouch, ready to become part of your daily ritual.',
    ...
    care: CARE_KEYCHAIN, price: 350, priceNote: PRICE_NOTE_FULL,
    gif: '/gif/1.gif', images: keyImgs, material: ['PLA'], size: { unit: 'cm', value: [4, 3, 1] },
    relatedProductIds: [14, 0, 3, 22], category: 'Keychains', status: 'Active', stock: 35,
    tags: ['keychain', 'custom', 'pocket', 'gift', 'affordable', 'charm', 'everyday'],
  },
  {
    id: 23, rank: 18,
    head: 'FOR EVERY OCCASION · GIFTING ESSENTIAL', title: 'Couple Keychain Set', subtitle: 'Two charms. One bond.',
    descriptions: [
    ...
    care: CARE_KEYCHAIN, price: 800, priceNote: PRICE_NOTE_FULL,
    images: keyImgs, material: ['PLA'], size: { unit: 'cm', value: [4, 3, 1] },
    relatedProductIds: [14, 4, 20, 3], category: 'Keychains', status: 'Active', stock: 25,
    tags: ['keychain', 'couple', 'love', 'pair', 'gift', 'anniversary', 'Valentine'],
  },
  // ─── Nameplates ────────────────────────────────────────────────────────────
  {
    id: 3, rank: 3,
    head: 'NAMEPLATE MEANING · CRAFTED IDENTITY', title: 'Custom Nameplate', subtitle: 'A name, made permanent.',
    descriptions: [
    ...
    care: CARE_NAMEPLATE, price: 1500, priceNote: PRICE_NOTE_FULL,
    gif: '/gif/1.gif', images: nmpImgs, material: ['PLA'], size: { unit: 'cm', value: [30, 10, 2] },
    relatedProductIds: [24, 0, 14, 8], category: 'Nameplates', status: 'Active', stock: 18,
    tags: ['nameplate', 'custom', 'Devanagari', 'Nepali', 'wall', 'home', 'identity', 'personalized'],
  },
  {
    id: 24, rank: 10,
    head: 'YOUR HOME · YOUR NAME', title: 'Door Nameplate', subtitle: 'The first thing people see.',
    descriptions: [
    ...
    care: CARE_NAMEPLATE, price: 1800, priceNote: PRICE_NOTE_FULL,
    images: nmpImgs, material: ['PLA', 'Weather-resistant coating'], size: { unit: 'cm', value: [35, 12, 3] },
    relatedProductIds: [3, 25, 0, 14], category: 'Nameplates', status: 'Active', stock: 22,
    tags: ['nameplate', 'door', 'outdoor', 'home', 'Nepali', 'Devanagari', 'weather-resistant'],
  },
  {
    id: 25, rank: 19,
    head: 'DESK IDENTITY · PROFESSIONAL PIECE', title: 'Office Desk Nameplate', subtitle: 'Your name, on your terms.',
    descriptions: [
    ...
    care: CARE_NAMEPLATE, price: 1200, priceNote: PRICE_NOTE_FULL,
    images: nmpImgs, material: ['PLA'], size: { unit: 'cm', value: [25, 8, 5] },
    relatedProductIds: [3, 24, 0, 14], category: 'Nameplates', status: 'Active', stock: 30,
    tags: ['nameplate', 'desk', 'office', 'professional', 'corporate', 'gift'],
  },
  // ─── Lamps ─────────────────────────────────────────────────────────────────
  {
    id: 1, rank: 11, isSignaturePiece: true,
    head: 'LET THEM GLOW · AMBIENT MEMORY', title: 'Portrait Litholamp', subtitle: 'A face in soft light.',
    descriptions: [
    ...
    care: CARE_LAMP, price: 4200, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['PLA', 'LED base'], size: { unit: 'cm', value: [12, 12, 15] },
    relatedProductIds: [2, 26, 8, 0], category: 'Lamps', status: 'Active', stock: 16,
    tags: ['lamp', 'litholamp', 'portrait', 'light', 'photo', 'glow', 'ambient', 'gift'],
  },
  {
    id: 2, rank: 13,
    head: 'UNDER THE STARS · MOONLIGHT MEMORY', title: 'Moon Lamp', subtitle: 'Your moment, illuminated.',
    descriptions: [
    ...
    care: CARE_LAMP, price: 3800, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['PLA', 'LED base'], size: { unit: 'cm', value: [15, 15, 18] },
    relatedProductIds: [1, 26, 8, 0], category: 'Lamps', status: 'Active', stock: 20,
    tags: ['lamp', 'moon', 'lunar', 'night', 'date', 'anniversary', 'romantic', 'gift'],
  },
  {
    id: 26, rank: 20,
    head: 'WARM GLOW · AMBIENT PRESENCE', title: 'Name Night Light', subtitle: 'Their name in light.',
    descriptions: [
    ...
    care: CARE_LAMP, price: 2800, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['PLA', 'LED strip'], size: { unit: 'cm', value: [40, 8, 10] },
    relatedProductIds: [1, 2, 3, 24], category: 'Lamps', status: 'Active', stock: 18,
    tags: ['lamp', 'name', 'night light', 'Nepali', 'children', 'bedroom', 'gift', 'glow'],
  },
  // ─── Sculptures ────────────────────────────────────────────────────────────
  {
    id: 8, rank: 1, isSignaturePiece: true,
    head: 'MILESTONE MARKED · TIME IN PHYSICAL FORM', title: 'Anniversary Sculpture', subtitle: 'Years together, made tangible.',
    descriptions: [
    ...
    care: CARE_STONE, price: 15000, priceNote: PRICE_NOTE_FULL,
    gif: '/gif/1.gif', images: figImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [15, 10, 20] },
    relatedProductIds: [0, 20, 3, 27], category: 'Sculptures', status: 'Active', stock: 6,
    tags: ['sculpture', 'anniversary', 'milestone', 'couple', 'love', 'premium', 'bespoke'],
  },
  {
    id: 27, rank: 15,
    head: 'IN REMEMBRANCE · A LASTING TRIBUTE', title: 'Memorial Piece', subtitle: 'So they are never truly gone.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 4500, priceNote: '50% prepayment required · Includes premium gift packaging · Personal delivery within Kathmandu',
    images: figImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [12, 8, 18] },
    relatedProductIds: [8, 0, 1, 20], category: 'Sculptures', status: 'Active', stock: 8,
    tags: ['memorial', 'remembrance', 'tribute', 'figurine', 'lamp', 'grief', 'healing'],
  },
  // ─── Puzzles ───────────────────────────────────────────────────────────────
  {
    id: 5, rank: 6,
    head: 'PUZZLE OF A MOMENT · PIECE BY PIECE', title: '3D Dinosaur Puzzle', subtitle: 'Build a memory together.',
    descriptions: [
    ...
    gif: '/gif/1.gif', images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [20, 20, 5] },
    relatedProductIds: [28, 0, 14, 3], category: 'Puzzles', status: 'Active', stock: 11,
    tags: ['puzzle', '3D', 'dinosaur', 'children', 'gift', 'educational', 'fun', 'activity'],
  },
  {
    id: 28, rank: 22,
    head: 'PUZZLE OF A MOMENT · PIECE BY PIECE', title: 'Custom Photo Puzzle', subtitle: 'Your memory, reassembled.',
    descriptions: [
    ...
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [20, 15, 1] },
    relatedProductIds: [5, 0, 14, 3], category: 'Puzzles', status: 'Active', stock: 16,
    tags: ['puzzle', 'photo', 'custom', 'memory', 'gift', 'personalised', 'activity'],
  },
  // ─── Home Decor ────────────────────────────────────────────────────────────
  {
    id: 29, rank: 9,
    head: 'ON YOUR DESK · DAILY REMINDER', title: 'Custom Desk Sculpture', subtitle: 'Art that earns its place.',
    descriptions: [
    ...
    care: CARE_STONE, price: 3200, priceNote: PRICE_NOTE_PARTIAL,
    images: mixImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [10, 10, 15] },
    relatedProductIds: [8, 3, 25, 0], category: 'Home Decor', status: 'Active', stock: 12,
    tags: ['desk', 'sculpture', 'office', 'art', 'meaningful', 'bespoke', 'home'],
  },
  {
    id: 30, rank: 23,
    head: 'WALL ART · MEMORY ON DISPLAY', title: 'Custom Wall Relief', subtitle: 'Memories worth hanging.',
    descriptions: [
    ...
    care: CARE_STONE, price: 5000, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [30, 30, 3] },
    relatedProductIds: [29, 8, 3, 0], category: 'Home Decor', status: 'Active', stock: 8,
    tags: ['wall art', 'relief', '3D', 'photo', 'home', 'interior', 'gift'],
  },
  // ─── Festival Gifts ────────────────────────────────────────────────────────
  {
    id: 31, rank: 7,
    head: 'DASHAIN · TIHAR · FESTIVAL GIFT', title: 'Festival Gift Set', subtitle: 'Crafted for the occasions that matter most.',
    descriptions: [
    ...
    care: CARE_KEYCHAIN, price: 2200, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['PLA'], size: { unit: 'cm', value: [20, 15, 8] },
    relatedProductIds: [14, 3, 0, 20], category: 'Festival Gifts', status: 'Active', stock: 20,
    tags: ['festival', 'Dashain', 'Tihar', 'gift set', 'Nepal', 'occasion', 'keychain', 'nameplate'],
  },
  {
    id: 32, rank: 16,
    head: 'WEDDING GIFT · FOREVER TOGETHER', title: 'Wedding Keepsake', subtitle: 'The beginning of forever.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 4000, priceNote: PRICE_NOTE_PARTIAL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [15, 10, 20] },
    relatedProductIds: [20, 8, 3, 1], category: 'Festival Gifts', status: 'Active', stock: 14,
    tags: ['wedding', 'couple', 'gift', 'keepsake', 'love', 'anniversary', 'personalized'],
  },
  {
    id: 33, rank: 21,
    head: 'NEW ARRIVAL · BIRTH MEMORY', title: 'Baby Footprint Frame', subtitle: 'The first mark they ever made.',
    descriptions: [
    ...
    price: 2500, priceNote: PRICE_NOTE_FULL,
    images: mixImgs, material: ['Resin'], size: { unit: 'cm', value: [20, 25, 3] },
    relatedProductIds: [22, 21, 27, 0], category: 'Festival Gifts', status: 'Active', stock: 16,
    tags: ['baby', 'newborn', 'footprint', 'birth', 'keepsake', 'memory', 'family', 'gift'],
  },
  {
    id: 37, rank: 26,
    head: 'GRADUATION · NEXT CHAPTER', title: 'Graduation Keepsake', subtitle: 'The years behind. The life ahead.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 2800, priceNote: PRICE_NOTE_FULL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [10, 8, 18] },
    relatedProductIds: [0, 3, 29, 25], category: 'Festival Gifts', status: 'Active', stock: 16,
    tags: ['graduation', 'achievement', 'figurine', 'keepsake', 'gift', 'milestone'],
  },
  {
    id: 38, rank: 27,
    head: 'BIRTHDAY · A YEAR REMEMBERED', title: 'Birthday Figurine', subtitle: 'For the one who deserves to be remembered.',
    descriptions: [
    ...
    care: CARE_FIGURINE, price: 1950, priceNote: PRICE_NOTE_PARTIAL,
    images: figImgs, material: ['PLA'], size: { unit: 'cm', value: [10, 8, 18] },
    relatedProductIds: [0, 14, 31, 20], category: 'Festival Gifts', status: 'Active', stock: 20,
    tags: ['birthday', 'figurine', 'gift', 'custom', 'personalized', 'celebration'],
  },
  // ─── Wearables ─────────────────────────────────────────────────────────────
  {
    id: 34, rank: 17,
    head: 'WORN WITH MEANING · WEARABLE MEMORY', title: 'Custom Pendant', subtitle: 'Carry a moment close.',
    descriptions: [
    ...
    images: keyImgs, material: ['Resin', 'Gold/Silver finish'], size: { unit: 'cm', value: [3, 3, 0.5] },
    relatedProductIds: [14, 4, 23, 0], category: 'Wearables', status: 'Active', stock: 30,
    tags: ['pendant', 'jewellery', 'wearable', 'custom', 'miniature', 'portrait', 'gift'],
  },
  // ─── Bespoke ───────────────────────────────────────────────────────────────
  {
    id: 35, rank: 24,
    head: 'BESPOKE · FULLY CUSTOM', title: 'Bespoke Commission', subtitle: 'If you can imagine it, we can make it.',
    descriptions: [
    ...
    images: figImgs, material: ['Varies'], size: { unit: 'cm', value: [0, 0, 0] },
    relatedProductIds: [8, 0, 20, 27], category: 'Bespoke', status: 'Active', stock: 5,
    tags: ['bespoke', 'custom', 'commission', 'one-of-a-kind', 'premium', 'unique', 'luxury'],
  },
  {
    id: 36, rank: 25,
    head: 'CORPORATE GIFT · MEANINGFUL RECOGNITION', title: 'Corporate Recognition Piece', subtitle: 'For the people who built something.',
    descriptions: [
    ...
    care: CARE_STONE, price: 6000, priceNote: 'Per unit pricing · Bulk discounts available · 50% prepayment required',
    images: mixImgs, material: ['PLA', 'Resin'], size: { unit: 'cm', value: [15, 10, 20] },
    relatedProductIds: [8, 29, 3, 35], category: 'Bespoke', status: 'Active', stock: 5,
...
async function main() {
  ...
  const dbHost     = process.env.NUXT_DB_HOST     || fileEnv.NUXT_DB_HOST     || '127.0.0.1';
  const dbPort     = Number(process.env.NUXT_DB_PORT || fileEnv.NUXT_DB_PORT || '3306');
  const dbUser     = process.env.NUXT_DB_USER     || fileEnv.NUXT_DB_USER     || 'root';
  const dbPassword = process.env.NUXT_DB_PASSWORD || fileEnv.NUXT_DB_PASSWORD || '';
  const dbName     = process.env.NUXT_DB_NAME     || fileEnv.NUXT_DB_NAME     || 'hamro3d';

  console.log(`Connecting to ${dbName} on ${dbHost}:${dbPort}...`);
  const connection = await mysql.createConnection({ host: dbHost, port: dbPort, user: dbUser, password: dbPassword, database: dbName });

  try {
    // Allow id=0 to be stored as literal zero
    await connection.query("SET sql_mode = 'NO_AUTO_VALUE_ON_ZERO';");

    // 1. Ensure all columns exist (safe to run repeatedly)
    const columnsToAdd = [
      "ALTER TABLE products ADD COLUMN IF NOT EXISTS gif VARCHAR(255) NULL AFTER images",
      "ALTER TABLE products ADD COLUMN IF NOT EXISTS tags JSON NULL AFTER size",
      "ALTER TABLE products ADD COLUMN IF NOT EXISTS is_signature_piece TINYINT(1) NOT NULL DEFAULT 0 AFTER tags",
    ];
    ...
    // 3. Insert products that don't yet exist
    console.log('Seeding products (INSERT IGNORE — existing rows skipped)...');
    let inserted = 0;
    let skipped = 0;
    for (const p of productsData) {
      ...
      const [result] = await connection.query(
        `INSERT IGNORE INTO products
           (id, \`rank\`, head, title, subtitle, descriptions, processes, care,
            price, price_note, images, gif, material, size, tags, is_signature_piece,
            status, stock, related_product_ids, category_id)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          p.id, p.rank, p.head, p.title, p.subtitle,
    ...
    console.log(`Total products in DB: ${countRows[0].total}`);
  } finally {
